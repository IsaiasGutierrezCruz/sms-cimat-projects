...
# Transponer para mejor visualizacion
...
Visualizamos la asociacion entre la variable Satisfaccion con Gravedad, Edad y Ansiedad:

```{r graficos_dispersion, fig.height=10}
...
- **Intercepto (beta_0):** Nivel de satisfaccion base cuando todas las variables independientes son cero.

- **Edad (beta_1):** Por cada ano adicional de edad, la satisfaccion cambia en el valor del coeficiente, manteniendo constantes las demas variables.

- **Gravedad (beta_2):** Por cada unidad adicional en el indice de gravedad, la satisfaccion cambia en el valor del coeficiente, manteniendo constantes las demas variables.

- **Medico/Quirurgico (beta_3):** Diferencia en satisfaccion entre pacientes quirurgicos (1) y medicos (0), manteniendo constantes las demas variables.

- **Ansiedad (beta_4):** Por cada unidad adicional en el indice de ansiedad, la satisfaccion cambia en el valor del coeficiente, manteniendo constantes las demas variables.
